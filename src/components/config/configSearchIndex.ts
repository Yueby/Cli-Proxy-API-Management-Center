...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  },
  {
    ...
    sectionId: 'system',
    labelKey: L('sections.system.codex_identity_confuse'),
    hintKey: L('sections.system.codex_identity_confuse_desc'),
...
export function getFieldRevealPatch(fieldId: string): { tlsEnable: true } | undefined {
  if (fieldId === 'tlsCert' || fieldId === 'tlsKey') return { tlsEnable: true };
  return undefined;
}
