      ...
      {(planLabel || expiryLabel || rateLimitResetCreditsAvailableCount !== null) && (
        <div className={classes.codexPlan}>
          ...
          {rateLimitResetCreditsAvailableCount !== null && (
            <span className={classes.codexPlanItem}>
              <span className={classes.codexPlanLabel}>{t('auth_files.quota.total_credits')}</span>
          ...
          {rateLimitResetCreditsApplicableAvailableCount !== null && (
            <span className={classes.codexPlanItem}>
              <span className={classes.codexPlanLabel}>
                {t('auth_files.quota.applicable_credits')}
              </span>
              <span className={classes.codexPlanValue}>
                {rateLimitResetCreditsApplicableAvailableCount.toString()}
              </span>
            </span>
          )}
        </div>
